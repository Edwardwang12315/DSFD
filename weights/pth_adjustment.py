...
def load_and_modify_vgg_weights(model_type, weight_path1,weight_path2,weight_path3, new_weight_path):
    ...
    for key, value in weights2.items():
        ...
        if model_type == 'vgg13':
            ...
            # new_key = key.replace('features.', 'vgg.features.') # 修改键名
            if int(key.split('.')[0]) > 4:
                del new_weights[key]
...
load_and_modify_vgg_weights('vgg16',weight_path1 ='./vgg16_reducedfc.pth',weight_path2='./vgg16_reducedfc.pth', weight_path3 = './vgg16_reducedfc.pth',new_weight_path = './vgg16_former2.pth')
